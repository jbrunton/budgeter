...
class StatementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create statement" do
    assert_difference('Statement.count') do
      post statements_url, params: { statement: { content: @statement.content, filename: @statement.filename, first_date: @statement.first_date, last_date: @statement.last_date, project_id: @statement.project_id } }
    end
  ...
  test "should update statement" do
    patch statement_url(@statement), params: { statement: { content: @statement.content, filename: @statement.filename, first_date: @statement.first_date, last_date: @statement.last_date, project_id: @statement.project_id } }
